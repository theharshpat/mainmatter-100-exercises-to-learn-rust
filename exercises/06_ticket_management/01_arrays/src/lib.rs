...
pub struct WeekTemperatures {
    week_day_temperature: [Option<i32>; 7]
}
...
impl WeekTemperatures {
    pub fn new() -> Self {
        Self{
            week_day_temperature: [None; 7]
        }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        self.week_day_temperature[day as usize]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        self.week_day_temperature[day as usize] = Some(temperature);
    }
}
